<template>
    <div class="play-data">
        ...
        <!--数据列表-->
        <el-table :data="playerList" style="width: 100%" max-height="250">
            ...
            <el-table-column prop="ua" label="UA" min-width="80"></el-table-column>
            <el-table-column prop="playTime" label="参与时间" min-width="100"></el-table-column>
        </el-table>
        <!-- 分页 -->
        <br>
        <el-pagination
...
<script>
    import {getPlayerListAPI} from '@/api/api'
    export default {
        data: function () {
            return {
                loading: false,
        ...
        methods: {
            ...
            getPlayerList () {
                ...
                getPlayerListAPI(params).then((res) => {
                    this.loading = false
                    if (res.code !== 0) {
